...
class horarios(models.Model):
    ...
    lunesEntrada = fields.Selection(string='Hora salida lunes', selection='_get_valid_hours', default='8')
    ...
    miercolesEntrada = fields.Selection(string='Hora salida miercoles', selection='_get_valid_hours', default='8')
    miercolesSalida = fields.Selection(string='Hora salida miercoles', selection='_get_valid_hours', default='8')
    juevesEntrada = fields.Selection(string='Hora salida jueves', selection='_get_valid_hours', default='8')
    juevesSalida = fields.Selection(string='Hora salida jueves', selection='_get_valid_hours', default='8')
    viernesEntrada = fields.Selection(string='Hora salida viernes', selection='_get_valid_hours', default='8')
